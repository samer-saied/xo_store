...
export default function AdminSectionsPage({ params }: any) {
  ...
  useEffect(() => {
    GetOneSection(params.id).then((section) => {
      console.log(section);
      setSection(section);
      setLoading(false);
    });
  ...
  return (
    <>
        ...
        <div className="flex flex-row justify-start items-center p-1">
          ...
          <h1 className=" w-6/12 text-center text-3xl font-bold">Sections</h1>
            ...
            <div className="p-4 border-t-2 border-blue-400 rounded-lg bg-gray-100/5 ">
              <div className="max-w-sm mx-auto md:w-full md:mx-0">
                <div className="inline-flex items-center space-x-4">
                    ...
                    />
                  <h1 className="text-gray-600">{section!.title}</h1>
                </div>
              </div>
            </div>
